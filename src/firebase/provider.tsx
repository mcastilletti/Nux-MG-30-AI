...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const contextValue = useMemo((): FirebaseContextState => {
    const servicesAvailable = !!(firebaseApp && firestore && auth && googleProvider);
    return {
  ...
  }, [firebaseApp, firestore, auth, googleProvider, userAuthState]);
...
export const useFirebase = (): FirebaseServicesAndUser => {
  ...
  if (!context.areServicesAvailable || !context.firebaseApp || !context.firestore || !context.auth || !context.googleProvider) {
